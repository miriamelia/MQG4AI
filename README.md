...
The proposed lifecycle blueprint design kit is envisioned to provide a unifying approach that bridges the gap between ethics, regulation, and accountable implementation [(RAI)](https://www.sciencedirect.com/science/article/pii/S1566253523002129), that enables human-AI collaboration through transparent and documented system design. MQG4AI *Information Blocks* address relevant contextual information. MQG4AI is intended as a contribution to AI QMS, which summarizes requirements for high-risk AI, as introduced in Article 17 of the AI Act, bridging implementation and regulation. 
